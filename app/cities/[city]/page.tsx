...
export default function CityPage() {
  ...
  useEffect(() => {
    if (params.city) {
      ...
      setCityName(city)
      const cityActivities = getActivitiesByCity(city)
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-12">
      ...
      <h1 className="text-3xl md:text-4xl font-bold text-purple-700 mb-8 text-center">
        Baby & Toddler Activities in {cityName}
      </h1>
      ...
      {activities.length > 0 ? (
            ...
            <Link key={activity.id} href={`/activities/${activity.id}`} className="group">
              <div className="bg-white rounded-lg shadow-md overflow-hidden transition-transform group-hover:shadow-lg">
                ...
                <div className="p-4">
                  ...
                  <p className="text-gray-700 mb-4">{activity.location.address}</p>
        ...
        <div className="text-center py-12 bg-gray-50 rounded-lg">
          <p className="text-gray-600 mb-4">No activities found in {cityName}.</p>
          <Link
            href="/"
      ...
      <div className="mt-12 text-center">
        <h2 className="text-2xl font-bold text-purple-700 mb-6">Are you a provider in {cityName}?</h2>
        <p className="text-gray-600 mb-6">
          List your baby and toddler activities on Happity for free and reach more families in your area.
        </p>
        <Link
          href="/list-activity"
